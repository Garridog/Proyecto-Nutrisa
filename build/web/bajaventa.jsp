...
<link href="https://fonts.googleapis.com/css2?family=Montserrat+Alternates&display=swap" rel="stylesheet">
    ...
    <body style="background-image: url(https://image.freepik.com/free-vector/ice-cream-doodle-seamless-pattern_3865-362.jpg); font-family: 'Montserrat Alternates'">
        ...
        <%
            ...
            String queryBaja = "DELETE from ventas WHERE idventa = '"+idventa+"'";
            int c = conexion.ejecutaSentenciaUpdate(queryBaja);
            ...
            <div class="jumbotron" style="background-color: white">
                ...
                <div class="thumbnail" style="border: solid black 0px">
                    <div class="alert alert-info" style="background-color: white">
                        ...
                        <hr>
                        <a href="index.html"><h5>Regresar al Menu Principal</h5></a>
                </div>
                <% }else{ %>
                <hr>
                <h2>*ERROR* No se elimino el resgistro!!!</h2>
                <hr>
                <% } %>
            </div>
        </div>
